...
from service.db.utils.elasticsearch_utils import ElasticsearchClient, HOT_SEARCH_BAIDU
from datetime import datetime, timedelta


class ZhiHuHotSeachSpider(object):
    __name__ = 'zhi hu hot search'
    ...
    def get_baidu_hot_seach(self):
        logger.info('Processing get zhi hu hot search list!')
