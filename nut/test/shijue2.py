    ...
    def save_data_to_es(self, data_list):
        ...
        try:
            ...
            for data in data_list:
                es.insert("shijue_china", data.get("type"), data)
    ...
    def parse_weibo_page_url(self, data):
        ...
        try:
            ...
            if page_url_obj:
                ...
                url_list = [
                    dict(url="https://s.weibo.com" + obj.contents[0].attrs.get("href"), keyword=data.get("keyword"))
...
shijue_qq = RedisQueue('shijue_id', namespace='shijue_id')


def run_shijue_weibo():
    from datetime import datetime
    def get_redis_page_url():
        b_data = shijue_qq.get_nowait()
        if b_data:
...
if __name__ == '__main__':
    ...
    sched.add_job(run_shijue_weibo, 'interval', seconds=2)
