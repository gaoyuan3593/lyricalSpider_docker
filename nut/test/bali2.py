    ...
    def save_data_to_es(self, data_list):
        ...
        try:
            ...
            for data in data_list:
                es.insert("weibo_paris_homes", data.get("type"), data)
...
bali_qq = RedisQueue('bali_qq', namespace='bali_qq')


def run_bali_weibo():
    from datetime import datetime
    def get_redis_page_url():
        b_data = bali_qq.get_nowait()
        if b_data:
...
if __name__ == '__main__':
    ...
    sched.add_job(run_bali_weibo, 'interval', seconds=2)
